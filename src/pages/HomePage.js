  ...
  return (
    <div className="homepage">
      ...
      <div className="image-text-container">
        {/* Replace the src attribute value with the online image URL */}
        <img src="https://scheduling-offline.s3.amazonaws.com/group_photos/Scholars_and_Faculty.jpg" alt="UTSA Top Scholar Program Scholars and Faculty" className="home-image" />
